...
exports.getGivenFeedbacks = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, relationsService.listGivenFeedbacks(id)];
            case 1:
                dbResponse = _a.sent();
                try {
                    res.send(dbResponse);
...
exports.getPendingFeedbacks = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, dbResponse;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, relationsService.listPendingFeedbacks(id)];
            case 1:
                dbResponse = _a.sent();
                try {
                    res.send(dbResponse);
