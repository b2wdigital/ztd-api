...
describe("Users", function () {
    ...
    beforeEach(function () {
        if (user_1.default.countDocuments()) {
    ...
    describe("User Creation", function () {
        ...
        it("Should add a list of users to database", function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    describe("User List", function () {
        it("Should return a list of user successfully", function () { return __awaiter(void 0, void 0, void 0, function () {
            var users, userList;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it("Should return an empty list when doesn't have an user", function () { return __awaiter(void 0, void 0, void 0, function () {
            var returnedUser;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    describe("User By Id", function () {
        it("Shouldnt return a unexistant user", function () { return __awaiter(void 0, void 0, void 0, function () {
            var returnedUser;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, user_1.default.findOne(mongoose_1.Types.ObjectId())];
                    case 1:
                        returnedUser = _a.sent();
        ...
        it("Should return a list of user successfully", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _id = (_a.sent())._id;
                        return [4 /*yield*/, user_1.default.findOne(_id)];
                    case 2:
                        returnedUser = _a.sent();
                        if (returnedUser) {
