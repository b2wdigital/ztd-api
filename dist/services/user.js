...
exports.list = exports.getById = exports.create = void 0;
...
exports.create = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var name, email, canEditCourse, canFeedback;
    return __generator(this, function (_a) {
        name = data.name, email = data.email, canEditCourse = data.canEditCourse, canFeedback = data.canFeedback;
        if (!name || name === "") {
        ...
        return [2 /*return*/, user_1.default.create(data)];
    });
}); };
